...
base_barb_sub: str = ["berserker", "wild heart", "world tree", "zealot"]
base_bard_sub: str = ["dance", "glamour", "lore", "valor"]
base_cler_sub: str = ["life", "light", "trickery", "war"]
base_drui_sub: str = ["land", "moon", "sea", "stars"]
base_figh_sub: str = ["battle master", "champion", "eldritch knight", "psi warrior"]
base_monk_sub: str = ["mercy", "shadow", "elements", "open hand"]
base_pala_sub: str = ["devotion", "glory", "ancients", "vengeance"]
base_rang_sub: str = ["beast master", "fey wanderer", "gloom stalker", "hunter"]
base_rogu_sub: str = ["arcane trickster", "assassin", "soulknife", "theif"]
base_sorc_sub: str = ["aberrant", "clockwork", "draconic", "wild magic"]
base_warl_sub: str = ["archfey", "celestial", "fiend", "great old one"]
base_wiza_sub: str = ["abjurer", "diviner", "evoker", "illusionist"]
eberron_arti_sub: str = ["alchemist", "armorer", "artillerist", "battle smith", "cartographer"]
